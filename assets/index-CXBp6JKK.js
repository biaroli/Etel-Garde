...
动作:必须并且只能是以下枚举之一，enter, exit, move, approach, retreat, jump, shake, attack, cast, hit, dodge, emotion, wander, look_around,fade, pull, dissolve,无动作写null
...
严禁在同一轮对话内让一个角色既进场又退场。当角色要退场时，必须在下一次她发言时输出退场动作，如 fade/pull/dissolve，随后角色才能消失。
