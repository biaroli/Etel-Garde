...
`);super({baseURL:i.baseURL,timeout:i.timeout??6e5,httpAgent:i.httpAgent,maxRetries:i.maxRetries,fetch:i.fetch}),this.completions=new En(this),this.chat=new At(this),this.embeddings=new Wn(this),this.files=new Ds(this),this.images=new Mn(this),this.audio=new tt(this),this.moderations=new Fn(this),this.models=new Os(this),this.fineTuning=new ye(this),this.graders=new zs(this),this.vectorStores=new be(this),this.beta=new Te(this),this.batches=new ds(this),this.uploads=new Gs(this),this.responses=new Us(this),this.evals=new it(this),this.containers=new nt(this),this._options=i,this.apiKey=t,this.organization=s,this.project=n}defaultQuery(){return this._options.defaultQuery}defaultHeaders(e){return{...super.defaultHeaders(e),"OpenAI-Organization":this.organization,"OpenAI-Project":this.project,...this._options.defaultHeaders}}authHeaders(e){return{Authorization:`Bearer ${this.apiKey}`}}stringifyQuery(e){return ur(e,{arrayFormat:"brackets"})}}Gn=R;R.OpenAI=Gn;R.DEFAULT_TIMEOUT=6e5;R.OpenAIError=S;R.APIError=G;R.APIConnectionError=It;R.APIConnectionTimeoutError=us;R.APIUserAbortError=Q;R.NotFoundError=Ta;R.ConflictError=$a;R.RateLimitError=Ga;R.BadRequestError=Fa;R.AuthenticationError=za;R.InternalServerError=Ha;R.PermissionDeniedError=Oa;R.UnprocessableEntityError=Ua;R.toFile=Ka;R.fileFromPath=Aa;R.Completions=En;R.Chat=At;R.ChatCompletionsPage=Nt;R.Embeddings=Wn;R.Files=Ds;R.FileObjectsPage=Es;R.Images=Mn;R.Audio=tt;R.Moderations=Fn;R.Models=Os;R.ModelsPage=Ts;R.FineTuning=ye;R.Graders=zs;R.VectorStores=be;R.VectorStoresPage=js;R.VectorStoreSearchResponsesPage=Js;R.Beta=Te;R.Batches=ds;R.BatchesPage=ps;R.Uploads=Gs;R.Responses=Us;R.Evals=it;R.EvalListResponsesPage=Rs;R.Containers=nt;R.ContainerListResponsesPage=Ps;class li{constructor(e,t,s){ce(this,"client");ce(this,"model");this.client=new R({apiKey:e,baseURL:t,dangerouslyAllowBrowser:!0}),this.model=s}async checkConnection(){try{return await this.client.models.list(),!0}catch(e){return console.error("Connection check failed:",e),!1}}async getModels(){try{return(await this.client.models.list()).data.map(t=>t.id)}catch(e){return console.error("Failed to get models:",e),[]}}async generateResponse(e,t){var s,n;try{const r={messages:e,model:this.model,temperature:(t==null?void 0:t.temperature)??1,top_p:(t==null?void 0:t.top_p)??1};t!=null&&t.top_k&&t.top_k>0&&(r.top_k=t.top_k);const o=((n=(s=(await this.client.chat.completions.create(r)).choices[0])==null?void 0:s.message)==null?void 0:n.content)||"";return this.parseTextResponse(o)}catch(r){throw console.error("Generation failed:",r),r}}parseTextResponse(e){let t="Narrator",s=e.trim();const n=s.match(/^\[(.*?)\]\s*(.*)/s);return n&&(t=n[1].trim(),s=n[2].trim()),{speaker:t,text:s}}}const ci=`
...
角色名:填写当前说话的角色名（例如:蕾拉）或使用旁白进行场景/动作描述。对于路人的角色名使用路人A，流氓A，老板娘，小贩A，商人C，地精A这样的命名方式，路人不需要具体名字
...
`).map(r=>r.trim()).filter(r=>r);this.state.dialogueLines=[];const n=/^\[(.*?)\]\s*(.*)$/;s.forEach(r=>{if(r.startsWith("<")&&r.endsWith(">"))return;const i=r.match(n);if(i){const o=i[1].trim(),l=i[2].trim(),u=o.split("|").map(d=>d.trim());u.length>2?this.state.dialogueLines.push({speaker:u[0]==="null"?"":u[0],action:u[1]==="null"?null:u[1],target:u[2]==="null"?null:u[2],vfxElement:u[3]==="null"?null:u[3],vfxMode:u[4]==="null"?null:u[4],vfxIntensity:u[5]==="null"?null:u[5],text:l}):this.state.dialogueLines.push({speaker:u[0],text:l})}else r&&this.state.dialogueLines.push({speaker:"",text:r})}),this.state.dialogueLines.length===0&&this.state.dialogueLines.push({speaker:"",text:"..."})},stopTypewriter(){this.state.typewriterTimeout&&clearTimeout(this.state.typewriterTimeout),this.state.isTyping=!1;const a=this.state.dialogueLines[this.state.currentIndex];a&&this.elements.dialogueText&&(this.elements.dialogueText.textContent=a.text)},typewriter(a,e,t){this.stopTypewriter(),this.state.isTyping=!0,e.textContent="";let s=0;const n=25,r=()=>{s<a.length?(e.textContent+=a.charAt(s),s++,this.state.typewriterTimeout=setTimeout(r,n)):(this.state.isTyping=!1,t&&t())};r()},async displayDialogue(){const a=this.state.dialogueLines[this.state.currentIndex];a&&(this.elements.speakerName&&(this.elements.speakerName.textContent=a.speaker),await this.syncSpritesAndVFX(a),this.elements.dialogueText&&this.typewriter(a.text,this.elements.dialogueText,()=>{this.state.isAutoPlaying&&this.scheduleNextDialogue()}))},advanceDialogue(){if(this.state.isTyping){this.stopTypewriter(),this.state.isAutoPlaying&&this.scheduleNextDialogue();return}this.state.currentIndex>=this.state.dialogueLines.length-1||(this.state.currentIndex++,this.displayDialogue())},previousDialogue(){this.state.isTyping&&this.stopTypewriter(),this.state.isAutoPlaying&&this.stopAutoPlay(),this.state.currentIndex>0&&(W.playSound("left"),this.state.currentIndex--,this.displayDialogue())},jumpToDialogue(a){a<0||a>=this.state.dialogueLines.length||(this.state.isTyping&&this.stopTypewriter(),this.state.isAutoPlaying&&this.stopAutoPlay(),this.state.currentIndex=a,this.displayDialogue(),this.toggleHistoryLog(!1))},toggleAutoPlay(){this.state.isAutoPlaying=!this.state.isAutoPlaying,this.elements.autoplayBtn&&(this.elements.autoplayBtn.classList.toggle("playing",this.state.isAutoPlaying),this.elements.autoplayBtn.innerHTML=this.state.isAutoPlaying?"自动 ❚❚":"自动 ▶"),this.state.isAutoPlaying&&!this.state.isTyping?this.scheduleNextDialogue():this.state.isAutoPlaying||this.stopAutoPlay()},stopAutoPlay(){this.state.isAutoPlaying=!1,this.elements.autoplayBtn&&(this.elements.autoplayBtn.classList.remove("playing"),this.elements.autoplayBtn.innerHTML="自动 ▶"),this.state.autoPlayTimeout&&clearTimeout(this.state.autoPlayTimeout)},scheduleNextDialogue(){var t;if(!this.state.isAutoPlaying)return;this.state.autoPlayTimeout&&clearTimeout(this.state.autoPlayTimeout);const a=this.elements.dialogueText&&((t=this.elements.dialogueText.textContent)==null?void 0:t.length)||0,e=Math.max(1500,a*100);this.state.autoPlayTimeout=setTimeout(()=>{this.advanceDialogue()},e)},toggleHistoryLog(a){if(!this.elements.historyLog)return;if(typeof a=="boolean"?this.elements.historyLog.classList.toggle("visible",a):this.elements.historyLog.classList.toggle("visible")){this.state.isAutoPlaying&&this.stopAutoPlay();let t="";this.state.dialogueLines.forEach((s,n)=>{const r=n===this.state.currentIndex?"current-line":"",i=this.getSpriteUrl(s.speaker);let o="";i?o=`<img src="${i}" loading="lazy">`:o='<span class="history-avatar-placeholder">📖</span>',t+=`
                        ...
                        </div>`}),this.elements.historyLog.innerHTML=t,setTimeout(()=>{const s=this.elements.historyLog.querySelector(".current-line");s&&s.scrollIntoView({behavior:"smooth",block:"center"})},10)}},async syncSpritesAndVFX(a){if(!this.elements.sprites)return;const e=a.speaker,t=a.action;let s=a.target;const n=a.vfxMode;if(this.state.lastSpeaker&&this.state.previousPositions[this.state.lastSpeaker]&&this.state.lastSpeaker!==e){const i=this.state.lastSpeaker,o=this.state.previousPositions[i],l=this.state.spriteSlots.findIndex(u=>u.name===i);l!==-1&&(this._assignSlotPos(l,o),delete this.state.previousPositions[i])}let r=this.state.spriteSlots.findIndex(i=>i.name===e);if(e&&this.getSpriteUrl(e)){let i=!1;if(r===-1){if(t==="exit")return;const u=s&&["far_left","left","center","right","far_right"].includes(s)?s:"center";r=this._findAvailableOrOverrideSlot(e,u),i=!0}const o=this.state.spriteSlots[r],l=this.elements.sprites[r];if(this.state.spriteSlots.forEach((u,d)=>{this.elements.sprites[d]&&(this.elements.sprites[d].classList.remove("active","inactive"),u.name&&u.url&&this.elements.sprites[d].classList.add(d===r?"active":"inactive"))}),t&&t!=="null")if(l.className=`galgame-sprite pos-${o.pos} active`,l.offsetWidth,i&&["enter","fade","pull","dissolve"].includes(t))t==="enter"||t==="fade"?l.classList.add("anim-enter-fade"):t==="pull"?l.classList.add("anim-enter-pull"):t==="dissolve"&&l.classList.add("anim-enter-dissolve");else if(!i&&["exit","fade","pull","dissolve"].includes(t))t==="exit"||t==="fade"?l.classList.add("anim-exit-fade"):t==="pull"?l.classList.add("anim-exit-pull"):t==="dissolve"&&l.classList.add("anim-exit-dissolve"),o.name=null;else switch(t){case"move":s&&["far_left","left","center","right","far_right"].includes(s)&&this._assignSlotPos(r,s);break;case"approach":if(s){const u=this.state.spriteSlots.findIndex(d=>d.name===s);if(u!==-1){this.state.previousPositions[e]=o.pos;const d=this.state.spriteSlots[u].pos,c={far_left:"left",left:"center",center:"right",right:"far_right",far_right:"right"};this._assignSlotPos(r,c[d]||"center")}}break;case"attack":case"cast":l.classList.add("anim-action-jump");break;case"hit":l.classList.add("anim-action-hit");break;case"shake":l.classList.add("anim-action-shake");break;case"dodge":this._createDodgePhantom(l),l.classList.add("anim-action-dodge");break}else l.src.includes(o.url)||(l.src=o.url,l.classList.add("anim-enter-fade"))}if(this.state.lastSpeaker=e,a.vfxElement&&a.vfxElement!=="none"){if(a.vfxElement==="screen_shake"||a.vfxElement==="screen_flash")await Kt.playScreenFx(a.vfxElement,a.vfxIntensity||"medium");else if(n&&n!=="none"){let i=r!==-1?this.elements.sprites[r]:null,o=null;if(s&&s!=="none"&&!["far_left","left","center","right","far_right"].includes(s)){const c=this.state.spriteSlots.findIndex(p=>p.name===s);c!==-1&&(o=this.elements.sprites[c])}const l=i?this._getCenterPos(i):{x:50,y:50},u=o?this._getCenterPos(o):null,d=Kt.playParticleVfx(a.vfxElement,n,a.vfxIntensity||"medium",l,u||void 0);(n==="explosion"||n==="beam"||n==="projectile")&&await d}}},_findAvailableOrOverrideSlot(a,e){const{spriteSlots:t}=this.state;let s=t.findIndex(i=>!i.name);s===-1&&(s=4),t[s].name=a,t[s].url=this.getSpriteUrl(a);let n=e;if(t.some((i,o)=>o!==s&&i.name&&i.pos===e)){const i=["far_left","left","center","right","far_right"],o=i.indexOf(e);n=i[(o+1)%5]}t[s].pos=n;const r=this.elements.sprites[s];return r.src=t[s].url,r.className=`galgame-sprite pos-${n}`,s},_assignSlotPos(a,e){if(a<0||a>4)return;this.state.spriteSlots[a].pos=e;const t=this.elements.sprites[a];t.className=`galgame-sprite active pos-${e}`},_createDodgePhantom(a){var t,s;const e=document.createElement("img");e.src=a.src,e.className=`galgame-ghost ${((t=a.className.match(/pos-[^\s]+/))==null?void 0:t[0])||"pos-center"}`,(s=document.getElementById("galgame-sprites"))==null||s.appendChild(e),setTimeout(()=>e.remove(),600)},_getCenterPos(a){var s;const e=(s=a.className.match(/pos-([^\s]+)/))==null?void 0:s[1];let t=50;return e==="far_left"&&(t=15),e==="left"&&(t=30),e==="right"&&(t=70),e==="far_right"&&(t=85),{x:t,y:50}},setBackground(a){const e=this.elements.bg;if(!e)return;let t=null;if(a){const s=a.split(/[\/,\\ >]+/).map(n=>n.trim()).filter(n=>n).reverse();for(const n of s){const r=this._getRandomAssetUrl(n,ve);if(r){t=`url('${r}')`;break}}if(!t)for(const n of s){if(n.length<2)continue;const i=Object.keys(ve).find(o=>o.includes(n));if(i){const o=this._getRandomAssetUrl(i,ve);if(o){t=`url('${o}')`;break}}}if(!t)for(const n of s){const i=Object.keys(ve).find(o=>n.includes(o)&&o!=="__default__");if(i){const o=this._getRandomAssetUrl(i,ve);if(o){t=`url('${o}')`;break}}}Pa(a)}t&&e.style.backgroundImage!==t&&(e.style.backgroundImage=t)},async _embedLatestSummary(){const a=O.getAllSummaries();if(a.length===0)return;const e=a[a.length-1],t=Hn.splitIntoChunks(e);if(t.length===0)return;const s=pe.config,r=await new wa({apiUrl:s.embeddingApiUrl,apiKey:s.embeddingApiKey,model:s.embeddingModel}).embed(t),i=O.getRoundCount(),o=t.map((l,u)=>({text:l,embedding:r[u],round:i}));se.addChunks(o)}},xi={init(){const a=document.querySelector(".menu-items-container"),e=document.querySelectorAll(".main-menu-item");!a||!e.length||(e.forEach(t=>{t.addEventListener("mouseenter",n=>{const r=a.getBoundingClientRect();a.style.setProperty("--hover-light-pos-x",`${n.clientX-r.left}px`),a.style.setProperty("--hover-light-pos-y",`${n.clientY-r.top}px`),a.style.setProperty("--hover-light-opacity","1")})}),a.addEventListener("mouseleave",()=>{a.style.setProperty("--hover-light-opacity","0")}),this.generateRunes())},generateRunes(){const a=document.querySelector(".celestial-glyphs");if(!a)return;a.innerHTML="";const e=["✧","⬖","⬘","⬙","✧","⬖","⬘","⬙"],t=46;e.forEach((s,n)=>{const r=n/e.length*2*Math.PI,i=document.createElement("span");i.className="rune-symbol",i.textContent=s,i.style.left=`${50+t*Math.cos(r)}%`,i.style.top=`${50+t*Math.sin(r)}%`,i.style.transform=`translate(-50%, -50%) rotate(${r*(180/Math.PI)+90}deg)`,a.appendChild(i)})}},Ve=`<content>
